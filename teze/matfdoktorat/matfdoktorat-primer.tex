...
\usepackage[cirlat,biblatex]{matfdoktorat}
%
...
%
% Opcija [cirlat]:
%   ako se koristi xetex, ovom opcijom uključujete mogućnost da tekst na srpskom
%   jeziku unosite latinicom, a da se on prikazuje ćirilicom. U tom slučaju 
%   tekst koji želite da ostane latinicom morate okružiti sa \lat{...} ili 
...
% primer tekst na engleskom jeziku
\begin{english}
