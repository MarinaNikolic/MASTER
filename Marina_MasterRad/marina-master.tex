...
\end{enumerate}
U narednom tekstu biće detaljno opisane implementacije obe celine, a celokupan k\^{o}d potreban za njihovu izgradju je dostupan u okviru \strano{git} repozitorijuma na adresi:\\
