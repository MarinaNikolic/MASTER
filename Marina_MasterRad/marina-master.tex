...
\begin{lstlisting}[caption={Osnovni izveštaj koji generiše \strano{gcov}},frame=single, label=simple]
        -:    0:Source:paskal.c
        -:    0:Graph:paskal.gcno
        -:    0:Data:paskal.gcda
        -:    0:Runs:1
...
\newpage
\begin{lstlisting}[caption={Izveštaj koji generiše alat \strano{gcov} sa opcijom -b},frame=single, label=branch]
        -:    0:Source:paskal.c
        -:    0:Graph:paskal.gcno
        -:    0:Data:paskal.gcda
        -:    0:Runs:1
...
\newpage
\begin{lstlisting}[caption={Izveštaj koji generiše alat \strano{gcov} sa opcijom -a},frame=single, label=block]
        -:    0:Source:paskal.c
        -:    0:Graph:paskal.gcno
        -:    0:Data:paskal.gcda
        -:    0:Runs:1
...
\kod{gcc lucky.o main.o –o lucky-vers2 -fprofile-arcs -ftest-coverage}
...
\kod{gcc –c lucky.c main.c –fprofile-arcs –ftest-coverage} \\
\kod{gcc lucky.o main.o -o lucky-vers3 –L<putanja do biblioteke libcoverage> -lcoverage <putanja do coverage\_registration>/coverage\_registration.o}
\end{enumerate}
...
\kod{cp libcovergage.so test\_workspace/runtime\_coverage} \\
...
\kod{ cp -r SRC/code\_coverage\_lib/ qemu\_test\_workspace/qemu\_version\_03/qemu/} \\
\kod{cp -r SRC/code\_coverage\_viewer/ qemu\_test\_workspace/qemu\_version\_03/qemu/} \\
